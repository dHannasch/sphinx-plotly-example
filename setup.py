...
setup(
    name='sphinx-plotly-example',
    use_scm_version={
        'local_scheme': 'dirty-tag',
        'write_to': 'src/sphinx_plotly_example/_version.py',
    ...
    url='https://github.com/dHannasch/sphinx-plotly-example',
    ...
    project_urls={
        'Documentation': 'https://sphinx-plotly-example.readthedocs.io/',
        'Changelog': 'https://sphinx-plotly-example.readthedocs.io/en/latest/changelog.html',
        'Issue Tracker': 'https://github.com/dHannasch/sphinx-plotly-example/issues',
    },
    keywords=[
    ...
    entry_points={
        'console_scripts': [
            'sphinx-plotly-example = sphinx_plotly_example.cli:main',
        ]
    },
)
